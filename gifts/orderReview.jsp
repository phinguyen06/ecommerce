...
<%
	...
	try {
		...
		if( String.valueOf(Constants.s_ORDER_SHIPPED_CODE).equals(orderProducts[0].getOrder().getStatus()) )
			...
			<tr>
				<td align=center>
					<table border="0" width="100%" cellspacing="0" cellpadding="0" align=center>
						<tr>
							<td align=center><b>Your order confirmation number: <i><%=confirmationNo%></i></b><br></td>
						</tr>
						<tr>
							<td align=center><b>Your order status: <i><%=StatusCodeDataProvider.getInstance().getStatus(order.getStatus()).getDescription()%></i></b></td>
						</tr>
					</table>
				</td>
			</tr>
