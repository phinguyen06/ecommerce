...
<table id="ctl00_columns" cellspacing="0" cellpadding="0" border="0"
	...
	<% }else{ %>
		...
		<h1 class="leftMenuTitleFont"><center>Administration Home</center></h1>
		<table cellspacing="0" cellpadding="2" border="0" style="width: 100%; border-collapse: ">
			<tr bgcolor=#CCCCCC>
				<td>Select your option on the left menu</td>
			</tr>
		</table>		
		</td>
	<% } %>
