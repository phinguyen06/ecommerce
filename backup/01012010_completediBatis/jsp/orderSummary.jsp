								...
								<table border="0" width="100%" cellspacing="0" cellpadding="2">
									<tr>
										...
										<br>
										    ...
										    <%
										    	//TEST CODE ONLY.  ONLY WORK WITH EMAIL BELLOW SO THAT WE CAN TEST OUR CODE DURING DEPLOYMENT
											if( session.getAttribute(Constants.s_LOGGIN) != null )
											{
												//login validation
												com.ebiz.data.User user = (com.ebiz.data.User)session.getAttribute(Constants.s_LOGGIN);	
												if ("brandon11151@yahoo.com".equals(user.getEmail())){
													out.println("<td align=left width=100>");
													out.println("<a id=btnCheckout href='javascript: createOrder()' class='buttontextp'><b>PHI ORDER NOW</b></a>");
													out.println("</td>");
												}
											}
										...
										<td align="left" width=100>
											<a id="btnCheckout" href="javascript: alert('Sorry for the inconvience.  Submit Order is coming soon.  Please check back regularly.')" class="buttontextp"><b>ORDER NOW</b></a>
											<a id=btnCheckout href='javascript: createOrder()' class='buttontextp'><b>PHI ORDER NOW</b></a>
										</td>
										<td align="left">
