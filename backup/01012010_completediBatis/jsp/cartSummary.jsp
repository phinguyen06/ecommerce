...
try
{
	...
	//PAYPAL VARIABLE
	session.setAttribute("Payment_Amount", "100.99");
}	
catch(Exception ex)
{
	...
	<% }else{ %>
		...
		<table id="ctl00_pageContent_ctl00_productList" cellspacing="0"
			...
			<tr>
				...
				<td>
					<%
						out.println(orderProducts[i].getWoodProduct().getName());
						//If backorded product, print red font WARNING to customer
						if( orderProducts[i].getBackordered() )
							out.println("<br><font color=red>"+Constants.s_PRODUCT_BACK_ORDER_MSG+"</font>");
					%>
				</td>
