...
public class Constants {
	...
	public final static String s_ORDER_ERROR_CODE = "E";
	public final static String s_ORDER_SUCCESS_CODE = "C";
	public final static String s_ORDER_PROCESSING_CODE = "P";
	public final static String s_ORDER_SHIPPED_CODE = "S";
