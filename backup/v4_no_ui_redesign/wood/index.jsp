...
<form name="frmLogon" method="post" action="<%=Constants.s_PAGE_ROOT%>servlet/LoginServlet">		
			<table cellspacing="0" cellpadding="0" border="0" width="100%" 
				style="background-image: url(images/sidemenubg.jpg); PADDING-BOTTOM: 500px; vertical-align: top; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 0px">
				<tr>
					<td colspan=2>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=2 align=center>
						<b>
							<a href="javascript: document.frmLogon.submit();">Logon</a> 
						</b>		
					</td>
				</tr>				
			</table>
