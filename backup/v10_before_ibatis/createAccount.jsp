												...
												<table width="100%" border="0" cellpadding="1"
													...
													<tr>
														...
														<td align="left"><input type="text" name="txtFName" value="<%=customer.getFirstName() == null ? "" : customer.getFirstName()%>"
															class="txtinput" maxlength="32" />&nbsp;<span class="inputRequirement"><font color=red>*</font></span></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><input type="text" name="txtEmail" value="<%=customer.getEmail() == null ? "" : customer.getEmail()%>"
															class="txtinput" maxlength="100" />&nbsp;<span class="inputRequirement"><font color=red>*</font></span></td>
													</tr>
												</table>
												</td>
											</tr>
										...
										<table border="0" cellpadding="1" cellspacing="2">
											...
											<tr>
												...
												<td><input type="text" name="txtAddress2" value="<%=customer.getAddress2() == null ? "" : customer.getAddress2()%>"
													class="txtinput" maxlength="100" />&nbsp;</td>
											</tr>
											<tr>
												<td>City:</td>
												<td><input type="text" name="txtCity" maxlength="26" class="txtinput"  value="<%=customer.getCity() == null ? "" : customer.getCity()%>"/>&nbsp;<span
											...
											<tr>
												...
												<td><input type="text" name="txtZip" maxlength="5" class="txtinput" value="<%=customer.getZip() == null ? "" : customer.getZip()%>" />&nbsp;<span
													class="inputRequirement"><font color=red>*</font></span></td>
											</tr>
										</table>
										</td>
										...
										<table border="0" cellpadding="1" cellspacing="2">
											...
											<tr>
												...
												<td><input type="text" name="txtShipCity" value="<%=customer.getShipCity() == null ? "" : customer.getShipCity()%>"
													class="txtinput" maxlength="26"/>&nbsp;<span class="inputRequirement"><font color=red>*</font></span></td>
											</tr>
											<tr>
												<td>State/Province:</td>
											...
											<tr>
												...
												<td><input type="text" name="txtShipZip" value="<%=customer.getShipZip() == null ? "" : customer.getShipZip()%>"
													class="txtinput"  maxlength="5"/>&nbsp;<span class="inputRequirement"><font color=red>*</font></span>
												</td>
											</tr>
										</table>
										</td>
									...
									<tr>
										...
										<table border="0" cellpadding="1" cellspacing="2">
											<tr>
												...
												<td><input type="text" name="txtPhone" class="txtinput" maxlength="10"  value="<%=customer.getContactPhone() == null ? "" : customer.getContactPhone()%>"/>&nbsp;<span
													class="inputRequirement"><font color=red>*</font></span></td>
											</tr>
											<tr>
												<td>Fax Number:</td>
												<td><input type="text" name="txtFax" value="<%=customer.getContactFax() == null ? "" : customer.getContactFax()%>"
													class="txtinput"  maxlength="10"/>&nbsp;</td>
											</tr>
										</table>
										</td>
									</tr>
										...
										<table border="0" cellpadding="1" cellspacing="2">
											<tr>
												...
												<td><input type="password" name="txtPassword"
													maxlength="40" class="txtinput" maxlength="10" value="<%=user==null ? "" : user.getPassword()%>"/>&nbsp;<span
													class="inputRequirement"><font color=red>*</font></span></td>
											</tr>
											<tr>
												<td>Confirm Pass:</td>
