...
public class DBConnection {
	...
	final String jdbcUrl = "jdbc:mysql://localhost:3306/ebiz?autoReconnect=true";
	final String dbUser = "phin";
	final String dbPassword = "phin";

	final String dataSourceContext = "java:/comp/env/jdbc/ebiz";
	...
	public DBConnection() throws ServiceException{
		try{
			...
			try
			{
				System.out.println("FAILED: Create connection pool within webapps context.  Create manual.");
