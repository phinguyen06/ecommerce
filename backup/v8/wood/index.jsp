	...
	<table cellspacing="0" cellpadding="0" width="100%" align=center>
		<tr>
			...
			<table cellspacing="0" cellpadding="0" width="500" align=center>
			  <tr>
				<td width=73 background="../images/menubg2_f.jpg" align=center>		
...
<table cellspacing="0" cellpadding="0" border="0" width="1024"
	style="background-image:url(/ebiz/wood/images/<%=pageBackground%>); PADDING-BOTTOM: 30px; background-repeat: no-repeat; PADDING-LEFT: 0px; border-collapse: collapse; ">
	<tr>
		<td width=10>&nbsp;</td>
