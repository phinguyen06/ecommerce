		...
		<tr>
			...
			<table cellspacing="0" cellpadding="0" width="500" align=center>
			  <tr>
				...
				<td width=1></td>
				<td width=186 background="../images/menubg4.jpg" align=center>
					<a style="TEXT-DECORATION: none; FONT-SIZE: 14px; COLOR: #333; FONT-FAMILY: arial,sans-serif" title="View Cart and Checkout" href="cartSummary.jsp"><font COLOR="blue">View Cart/Checkout</font></a>
				</td>
				<td width=1></td>
				<td width=108 background="../images/menubg3.jpg" align=center>
...
<table id="ctl00_columns" cellspacing="0" cellpadding="0" border="0" width="1024"
	style="background-image:url(/ebiz/wood/images/pageBackground3.jpg); PADDING-BOTTOM: 30px; background-repeat: no-repeat; PADDING-LEFT: 0px; border-collapse: collapse; ">
	<tr>
		<td width=20>&nbsp;</td>
		...
		<br><br>
		<h1 class="leftMenuTitleFont"><center>Shipping Policy</center></h1>
		<table cellspacing="0" cellpadding="2" border="0" style="width: 50%; border-collapse;" align=center>
			<tr>
				<td style="FONT-SIZE: 14px; FONT-FAMILY: Verdana; ">
					Most orders leave our warehouse within 3-5 business days (not including weekends) from date of order. 
					Orders are not in our warehouse because of no inventory available that need to be made by our manufacturer will leave our 
					warehouse within 20-25 business days (not including weekends) from date of order.
					Please estimate about 5 - 10 days for delivery time from the date the order is released to shipping. 
					Shipping schedule for wholesale orders will be discussed with the customer prior to completing an order. 
					The customer is responsible for providing an accurate shipping information. 
				</td>
			</tr>
		</table>
		</td>
