...
{	
	...
	if( session.getAttribute(Constants.s_CUSTOMER_ORDER_CART) == null )
		throw new Exception("Your shopping cart session is invalid.  Please start a new shopping cart.");
}	
catch(Exception ex)
{
...
<table id="ctl00_columns" cellspacing="0" cellpadding="0" border="0" width="1024"
	...
	<tr>
		...
		<br><br>
		<h1 class="leftMenuTitleFont"><center>Ordering Processing</center></h1>
		<table cellspacing="0" cellpadding="2" border="0" style="width: 50%; border-collapse;" align=center>
			<tr>
				<td style="FONT-SIZE: 14px; FONT-FAMILY: Verdana; " align=center>
					 Please wait while we are processing your order...<br><br>
					  <div id="preview">
					    <div id="previewinner">
					      <div id="loaderin"><img src="../images/wait_bert4.gif" alt="Please wait while processing..." /></div>
					    </div>
					  </div>
				</td>
			</tr>
