...
<body>
<form name="frm" method="post" action="contactUs.jsp" id="mainForm">
<center>
		...
		<tr>
			...
			<table cellspacing="0" cellpadding="0" width="500" align=center>
			  <tr>
				...
				<td width=1></td>
				<td width=108 background="../images/menubg3_f.jpg" align=center>
...
<table cellspacing="0" cellpadding="0">
	<tbody>
		...
		<tr>
			<td class="containerFooter" align="center">Power By © eBiz.com
			</td>
		</tr>
	</tbody>
</table>
